  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        description="Hiển thị giao dịch liên quan đến tài khoản bạn sở hữu."
      />
            ...
            <TableBody>
              {rows.map((t) => (
                <TableRow key={t.id}>
                  ...
                  <TableCell className="font-mono text-xs">{t.sourceAccountNumber ?? "—"}</TableCell>
                  <TableCell className="font-mono text-xs">{t.destinationAccountNumber ?? "—"}</TableCell>
